  ...
  <section class="bg-accent2 about">
    ...
    <div class="about-box flex justify-between">
        <div class="description flex column">
            ...
            <div>
                <a href="https://my-portfolio-dev-a4a9c.web.app/curriculo3.pdf" class="link-action bg-accent text-bold" download="curriculo3.pdf">Baixar CV</a>
            </div>
        </div>
